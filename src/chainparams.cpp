...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 32584;  //32584
        bnProofOfWorkLimit = ~uint256(0) >> 20; // BTRF starting difficulty is 1 / 2^12  //20
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 300; // BTRF: 3 hours // 1 day
        nTargetSpacing = 1 * 300;  // BTRF: 135 sec
        nLastPOWBlock = 300;
        nMaturity = 144;
         ...
         *   vMerkleTree: e0028e
		 //Testblock
		 python genesis.py -a quark -z "The times 31.08.2016 Bittransfer was founded - Designed Team Bitsend" -t 1502817296 -v 0
		 Z:\VMS\Gen\genquark>python genesis.py -a quark -z "The times 31.08.2016 Bittransfer was founded - Designed Team Bitsend" -t 1502817296 -v 0
...
pszTimestamp: The times 31.08.2016 Bittransfer was founded - Designed Team Bitsend
...
genesis hash: 000002d56463941c20eae5cb474cc805b646515d18bc7dc222a0885b206eadb0
         */
        const char* pszTimestamp = "The times 08.10.2017 Bittransfer Team";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1507461314;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4096634;
...
*/
        assert(hashGenesisBlock == uint256("0x000003d7bba2e39eda79cc7eb636523e4a6566204e5f2f3d92e4abe95cda23ab"));
        assert(genesis.hashMerkleRoot == uint256("0x2206bff087d5219ff32e66a90fe554be1096d3f9e32c4c0942e41fa76faab7f7"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 135; // BTRF: 1 day
        nTargetSpacing = 1 * 135;  // BTRF: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bittransfer addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bittransfer script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bittransfer BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bittransfer BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bittransfer BIP44 coin type is '1' (All coin's testnet default)
