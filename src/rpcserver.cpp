...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Diamond features */
        {"bittransfer", "masternode", &masternode, true, true, false},
        {"bittransfer", "masternodelist", &masternodelist, true, true, false},
        {"bittransfer", "mnbudget", &mnbudget, true, true, false},
        {"bittransfer", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"bittransfer", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bittransfer", "mnsync", &mnsync, true, true, false},
        {"bittransfer", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"bittransfer", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bittransferd, or the -server option to bittransfer-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bittransfer-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32585/\n";
}
