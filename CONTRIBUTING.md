Contributing to BTRF Core
============================

The BTRF Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BTRF Core project, and is not to be
confused with overall BTRF Network Protocol consensus changes.

Whether a pull request is merged into BTRF Core rests with the project merge
...
Patches that change BTRF consensus rules are considerably more involved than
...
Where a patch set proposes to change the BTRF consensus, it must have been
...
The project leader is the release manager for each BTRF Core release.
