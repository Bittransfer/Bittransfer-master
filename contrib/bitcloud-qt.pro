...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bittransfer-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/bittransfer-cli.cpp \
           src/bittransfer-tx.cpp \
           src/bittransfer.cpp \
           src/db.cpp \
           ...
           src/qt/bittransfer.cpp \
           src/qt/bittransferstrings.cpp \
...
RESOURCES += src/qt/bittransfer.qrc src/qt/bittransfer_locale.qrc

TRANSLATIONS += src/qt/locale/bittransfer_bg.ts \
                src/qt/locale/bittransfer_de.ts \
                src/qt/locale/bittransfer_en.ts \
                src/qt/locale/bittransfer_es.ts \
                src/qt/locale/bittransfer_fi.ts \
                src/qt/locale/bittransfer_fr.ts \
                src/qt/locale/bittransfer_it.ts \
                src/qt/locale/bittransfer_ja.ts \
                src/qt/locale/bittransfer_pl.ts \
                src/qt/locale/bittransfer_pt.ts \
                src/qt/locale/bittransfer_ru.ts \
                src/qt/locale/bittransfer_sk.ts \
                src/qt/locale/bittransfer_sv.ts \
                src/qt/locale/bittransfer_vi.ts \
                src/qt/locale/bittransfer_zh_CN.ts \
                src/qt/locale/bittransfer_zh_TW.ts
