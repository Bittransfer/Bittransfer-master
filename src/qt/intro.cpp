...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BTRF Core"),
     ...
     * override -datadir in the bittransfer.conf file in the default data directory
     * (to be consistent with bittransferd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
