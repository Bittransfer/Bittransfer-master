...
In order to support loading of multiple wallets in bittransfer-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bittransfer.cpp.
...
Changes to bittransfer.cpp
----------------------
bittransfer.cpp is the entry point into bittransfer-qt, and as such, will require some minor modifications to provide hooks for
