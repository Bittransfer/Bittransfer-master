...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BTRF);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeDiamondAmount"))
        SoftSetArg("-anonymizebittransferamount", settings.value("nAnonymizeDiamondAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bittransfer.cpp during shotdown to also remove the window positions
