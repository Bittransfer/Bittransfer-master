...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Diamond Core bittransfer-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bittransfer-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bittransfer transaction") + "\n" +
                               "  bittransfer-tx [options] -create [commands]   " + _("Create hex-encoded bittransfer transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bittransfer transaction
