                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BTRF - BitCloud") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BTRF address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bittransfer: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BTRF Core"), this);
    aboutAction->setStatusTip(tr("Show information about BTRF Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BTRF"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BTRF addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BTRF addresses"));
    ...
    openAction->setStatusTip(tr("Open a BTRF: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BTRF Core help message to get a list with possible BTRF command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BTRF Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BTRF network", "", count));
}
...
{
    QString strTitle = tr("BTRF Core"); // default title
