...
/** Utility functions used by the BTRF Qt UI.
 */
namespace GUIUtil
{
...
// Render BTRF addresses in monospace font
...
// Parse "bittransfer:" URI into recipient object, return true on successful parsing
